        ...
        <div id='navbar' className="navbar bg-[#181818] text-[#fff] fixed z-10">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow rounded-box w-52 text-[#181818] bg-white">
                        {menuItems}
                    </ul>
                </div>
                <Link to='/' className="">
                    <img src={logo} alt='' className='w-36 bg-transparent border-0' />
