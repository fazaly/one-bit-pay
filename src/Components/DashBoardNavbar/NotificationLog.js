        ...
        <div className=' '>
            {user?.email === transactionsData?.senderEmail ?
                <div className='bg-[#241f71c4] text-white p-4 rounded-2xl flex justify-between'>
                    <span className='flex items-center gap-2 '><span className='text-red-500' ><FaArrowUp></FaArrowUp></span>
                ...
                <div className='bg-[#241f71d0] text-white p-4 rounded-2xl flex justify-between'>
                    <span className='flex items-center gap-2'> <span className='text-green-500'><FaArrowDown></FaArrowDown></span> ${transactionsData?.amount}</span>
