...
const ApplyForLoan = () => {
    return (
        <div className='mt-5 mb-10'>
            ...
            <h2 className='mt-10'>Getting a small, quick loan is now easier than ever! The BitPay Bank is introducing instant Digital Loan for OneBitPay users without requiring any paperwork.</h2>
            ...
            <h2 className='text-2xl font-semibold mt-10 mb-10'>Loan Details:</h2>
            ...
            <h2 className='text-2xl font-semibold mt-10 mb-10'>Loan Payback Details:</h2>
            ...
            <h2 className='text-2xl font-semibold mt-10 mb-10'>Loan Eligibility Criteria: </h2>
