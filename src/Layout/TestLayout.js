    ...
    <div>
      <div className="drawer drawer-mobile">
        ...
        <div className="drawer-side shadow-2xl">
          ...
          <ul className="menu p-6 w-80 bg-[#181818] text-white relative ">
            <label
              onClick={() => setOpen(!open)}
              htmlFor="my-drawer-2"
              className=" p-2 w-8 absolute -right-8 rounded-tr-full rounded-br-full duration-300 mt-16 bg-[#181818]"
            >
              {open ? (
                <HiChevronDoubleLeft className="text-lg text-[#FFF]" />
              ) : (
                <HiChevronDoubleRight className="text-lg text-[#FFF]" />
              )}
            </label>
            {/* <!-- Sidebar content here --> */}
            <div className="w-52 flex flex-col justify-center items-center  rounded-md p-2 ml-3 ">
              <Link to="/" className="">
                <img src={logo} alt="" className="w-46 btn bg-transparent border-0" />
              </Link>
            </div>
            <div className=" p-4">
            ...
            {userDetails?.role === "user" && (
              ...
              >
                <button className="btn mt-10 w-full text-lg border-none bg-[#5966FF] hover:bg-[#5966FF]">BECOME AN AGENT</button>
              </Link>
            )}
          </ul>
        </div>
